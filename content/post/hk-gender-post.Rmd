...
pop <- read_csv("D:/rproj/hk-gender/precleaned_data/preclean-excel.csv", #this data is by nationality
                                  na = '-',
...
without_helpers <- read_csv("D:/rproj/hk-gender/precleaned_data/withouthelpers-preclean.csv", #this data is by ethnicity
                            na = '-') %>% 
  gather(Chinese:Multiracial, key = 'ethnicity', value = 'population')

with_helpers <- read_csv("D:/rproj/hk-gender/precleaned_data/withhelpers-preclean.csv", 
                         na = '-') %>% 
  gather(Chinese:Multiracial, key = 'ethnicity', value = 'population')
...
source('D:/rproj/hk-gender/functions/annotate_color.R') #load annotate_color()

source('D:/rproj/hk-gender/functions/title_no_clip_markdown.R')
