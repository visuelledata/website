...
library(tictoc)
```
[![Travis-CI Build Status](https://travis-ci.org/visuelledata/frite.svg?branch=master)](https://travis-ci.org/visuelledata/frite)[![](https://cranlogs.r-pkg.org/badges/frite)](https://cran.r-project.org/package=frite)[![CRAN Status Badge](http://www.r-pkg.org/badges/version/frite)](https://cran.r-project.org/package=frite)

##Introduction

**frite** is a package that enables one to easily write and modify functions. It can be used to inject, assign, or remove code in a function.  There are also functions that enable you to use this package more easily. You can use the diagnostic functions to test any function that you can think of. It also has applications in code generation or metaprogramming. 
