...
<img src="D:/rproj/website/static/img/plot1.jpeg" alt="Total app usage" height="220" width="600">
<!-- ![Total app usage](/post/app_report_post_files/plot1.jpeg){width=220px height=600px} -->
<!-- <img src = "/img/plot1.jpeg"></img> -->
<!-- ![](/post/app_report_post_files/plot1.jpeg){width=220px height=600px} -->

Top 10 apps have changed see: Hyperion, Keep

<img src="D:/rproj/website/static/img/plot2.jpeg" alt="Group of plots" height="600" width="600">

<!-- ![Group of plots](/post/app_report_post_fi![](/post/app_report_post_files/plot1.jpeg){width=220px height=600px}les/plot2.jpeg){width=600px height=600px} -->
